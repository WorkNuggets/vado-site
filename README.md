...
- **Development server not starting or crashing:** Ensure your Node.js version is up-to-date (Node 18+). Older Node versions may not support Astro 4 features. If you see errors during npm install, try deleting the node_modules folder and running a clean install.
